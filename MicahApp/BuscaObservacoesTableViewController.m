//
//  BuscaObservacoesTableViewController.m
//  MicahApp
//
...
@interface BuscaObservacoesTableViewController ()

@end

@implementation BuscaObservacoesTableViewController
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return self.observacoesFiltradosArray.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    labelNome.text = self.observacoesFiltradosArray[indexPath.row];
